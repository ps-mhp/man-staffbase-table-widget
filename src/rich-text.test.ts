...
describe("sanitizeRichText", () => {
  ...
  it("keeps images with a root-relative src", () => {
    expect(sanitizeRichText('<img src="/api/media/secure/x.jpeg">')).toBe(
      '<img src="/api/media/secure/x.jpeg" alt="" style="height:auto">',
    );
  });
